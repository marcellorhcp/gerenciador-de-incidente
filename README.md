...
<p align="center">
  <img alt="gerenciadorIncidente" src=".github/cover.jpg" width="640px">
</p>
...
To build the final jar and optimize the gerenciadorDeIncidente application for production, run:
